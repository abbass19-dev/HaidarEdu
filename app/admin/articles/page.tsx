...
import { Edit2, Trash2, Plus, Eye, Calendar, EyeOff, X } from 'lucide-react';
import { getArticles, addArticle, deleteArticle, updateArticle } from '@/lib/db';
                ...
                <div style={{ overflowX: 'auto' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '700px' }}>
                        ...
                        <tbody>
                            ...
                            {!loading && articles.length === 0 && <tr><td colSpan={4} style={{ textAlign: 'center', padding: '20px' }}>No articles found. Add your first article!</td></tr>}
                        </tbody>
                    </table>
                </div>
            </div>
