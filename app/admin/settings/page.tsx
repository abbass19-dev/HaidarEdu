...
import { Save, AlertTriangle, Settings, ToggleLeft, ToggleRight, Upload, Image as ImageIcon } from 'lucide-react';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                ...
                <div className="glass" style={{ padding: '32px', borderRadius: 'var(--radius-lg)' }}>
                    <h3 style={{ fontSize: '1.2rem', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <ImageIcon size={20} color="var(--primary-lime)" /> Brand Configuration
                    </h3>
