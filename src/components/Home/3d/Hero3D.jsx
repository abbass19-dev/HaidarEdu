    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* 3. Floating Elements (Front Depth) */}

                {/* Floating Coin/Icon Top Right */}
                {/* Floating Coin/Icon Top Right */}
                <motion.div
                    style={{
                        position: 'absolute',
                ...
                {/* Floating Blur Sphere Bottom Right (New) */}
                <motion.div
                    style={{
                        position: 'absolute',
                        bottom: '20px',
