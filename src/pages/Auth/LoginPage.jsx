...
const LoginPage = () => {
    ...
    const handleEmailLogin = async (e) => {
        ...
        try {
            ...
            const { getUserRole } = await import('../../firebase/db');
        ...
        <main style={{
            ...
            >
                ...
                <p style={{ marginTop: '32px', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                    Don't have an account? <Link to="/signup" style={{ color: 'var(--primary-lime)', textDecoration: 'none', fontWeight: '600' }}>Sign Up</Link>
                </p>
            </motion.div>
        </main>
    );
